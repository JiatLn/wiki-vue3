// from: https://github.com/xukeler/chinesePY/blob/master/ChinesePY.js
var Pinyin = {} as any;
Pinyin._JMcode = {
  '-': '',
  '—': '',
...
//单词首字母获取
Pinyin.getWordsCode = function (str: string) {
  str = str.toUpperCase();
...
Pinyin._ucfirst = function (l1: string) {
  if (l1.length > 0) {
 ...
 * 获取汉字的简码拼音
 */
Pinyin.GetJP = function (str: string) {
  str = str.toUpperCase();
  var len = str.length;
  var c,
    result = '',
...
Pinyin.GetQP = function (l1: string) {
  var l2 = l1.length;
  var I1 = '';
 ...
 */
Pinyin.GetHP = function (str: string) {
  var result = '';
